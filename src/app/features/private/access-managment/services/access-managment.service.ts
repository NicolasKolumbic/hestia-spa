...
export class AccessManagmentService {
    ...
    listUsers(query: ListUsersQuery): Observable<GridResponse<UserAccess>> {
        let params = new HttpParams().set('clientId', query.clientId);
        ...
        return this.#http.get<GridResponse<UserAccess>>(`${this.apiUrl}/users`, { params });
    }
